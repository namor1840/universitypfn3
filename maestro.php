...
if (!isset($_SESSION['user_id']) || $_SESSION['user_role'] !== 'maestro') {
...
<body class="bg-white flex">
    ...
    <ul class="space-y-2">
        <li class="flex justify-center"><a href="misalumnos.php" class="text-black hover:text-gray-400"><span class="mr-2">Mis Alumnos</span><i class="fas fa-user-shield"></i></a></li>
